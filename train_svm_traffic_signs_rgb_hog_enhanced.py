# train_svm_traffic_signs_rgb_hog_enhanced.py
...
MODEL_SAVE_PATH = 'svm_traffic_sign_rgb_hog_enhanced.joblib'
IMAGE_SIZE = (64, 64)
BINS = 16  # Histogram bins

# ------------------------------
# Enhancement Function (Weak A)
# ------------------------------
def enhance_image(img):
    # Convert to HSV to boost color
    hsv = cv2.cvtColor(img, cv2.COLOR_BGR2HSV)
    h, s, v = cv2.split(hsv)

    # Boost color saturation (+30%)
    s = cv2.multiply(s, 1.3)

    # CLAHE on brightness channel for lighting correction
...
if __name__ == "__main__":
    ...
    print("Loading dataset with enhancement...")
